...
Evaluated on real invoice OCR data with a local qwen2.5 model with **~76% precision at 50% coverage, AURC 0.23, ECE ~0.03.** The ablation was the interesting part: self-consistency did nearly all the work (AURC 0.34 → 0.23), while a two-temperature signal I expected to help measured as completely redundant. I kept that result in the README rather than quietly dropping it.
...
![RFM customer segments](https://lolale3.github.io/images/cluster.jpg?raw=true)
